...
| **Nedelcu Calin** | Partea a II-a — **Cercetarea** | 11–19 | șase perspective asupra parabolei, încheierea, Q&A |
...
- Calin: „Eu prezint **Partea a II-a — Cercetarea: șase perspective asupra parabolei** — aceeași curbă ca loc geometric, oglindă, limită, sumă infinită și conică, fiecare cu definiție, teoremă și demonstrație, doar cu materia claselor IX–XI."
- Pe scurt, oricare: „*Șase perspective asupra parabolei* — Vlad acoperă lecția, Calin cercetarea."
...
🗣 „Bună ziua! Suntem Vlad Boștină și Calin Nedelcu, iar proiectul nostru se numește *Parabola*. Toți știm parabola ca graficul funcției de gradul al II-lea din clasa a IX-a. Teza proiectului nostru este însă alta: **parabola nu e doar un grafic — e o curbă care poate fi studiată din șase perspective matematice diferite**: ca grafic, ca loc geometric, ca oglindă, ca limită, ca sumă infinită și ca secțiune conică. Prezentarea are două părți: eu prezint fundamentele — lecția clasică — iar Calin partea de cercetare. Și totul, subliniez, e demonstrat doar cu materia claselor a IX-a – a XI-a."
...
## 11 · DIVIDER „Șase perspective asupra parabolei" (40 sec) — de aici preia CALIN

🗣 „Mulțumesc, Vlad. De aici preiau eu, cu partea de cercetare. Prima perspectivă — parabola ca grafic — tocmai ați văzut-o. Urmează celelalte cinci: **loc geometric, oglindă, limită, sumă infinită și conica de frontieră**, plus două instrumente care le leagă între ele: tangentele și asemănarea.
...
🗣 „Prima perspectivă nouă: parabola ca **loc geometric**. Întâi termenul: **loc geometric înseamnă mulțimea tuturor punctelor din plan care îndeplinesc o proprietate dată.**
...
🗣 „A treia perspectivă: parabola ca **oglindă perfectă**. **Teoremă — proprietatea optică: orice rază paralelă cu axa de simetrie, după reflexie pe parabolă, trece prin focar.** Legea reflexiei spune că unghiul de incidență e egal cu unghiul de reflexie, măsurate față de tangentă.
...
🗣 „A patra perspectivă: parabola văzută prin **limite** — geometria diferențială, dar construită cinstit, cu materia noastră.
...
🗣 „A cincea perspectivă: parabola ca **sumă infinită** — și un strop de istorie. Acum 2 250 de ani, Arhimede a demonstrat un rezultat uluitor, în lucrarea *Cvadratura parabolei*.
...
🗣 „A șasea perspectivă: parabola ca membru al unei familii — **conicele**. **Definiție: o conică este mulțimea punctelor din plan ale căror coordonate verifică o ecuație de gradul al II-lea: Ax² + Bxy + Cy² + Dx + Ey + F = 0**, cu A, B, C nu toate nule.
...
🗣 „În concluzie: am plecat de la trei coeficienți — a, b, c — și am studiat aceeași curbă din **șase perspective**: grafic, loc geometric, oglindă, limită, sumă infinită și conică de frontieră. Șase perspective — o singură parabolă.
