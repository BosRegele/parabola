...
> **Durata totală: ~21 de minute** (versiunea completă) sau **~13 minute** (versiunea comprimată).
> Numerotarea de mai jos e cea din contorul de pe ecran (01/18 … 18/18).
...
## 16 · CONICA GENERALĂ ȘI MATRICEA EI (2 min)
...
## 17 · TOATE PARABOLELE SUNT ASEMENEA (1 min)
...
→ „Pentru că funcția de gradul II acoperă doar parabolele cu axă verticală — un caz particular. Definiția cu focar și directoare include toate parabolele din plan, inclusiv pe cele rotite (vezi conicele, slide 16). Așa graficul devine consecință, nu definiție."
...
- 05–10 (discriminant, rădăcini, Viète, vârf, semn, 6 cazuri): doar definiția + o frază fiecare. **2,5 min**.
- 11 (Calculator): un singur gest. **30 sec**.
- 12–17 (cercetarea): toate intacte. **~6 min**.
- Demo-uri live obligatorii: **înfășurătoarea (12), cercul osculator cu h → 0 (14), conicele (16)**.
