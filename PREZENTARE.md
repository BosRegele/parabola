...
> **Durata totală: ~22 de minute** (versiunea completă) sau **~13 minute** (versiunea comprimată).
...
## 04 · FUNCȚIA DE GRADUL AL II-LEA (1 min)

🗣 „**Definiție: funcția f : ℝ → ℝ, f(x) = ax² + bx + c, cu a ≠ 0, se numește funcție de gradul al II-lea.** Din corolarul precedent, graficul ei este o **parabolă cu axa de simetrie paralelă cu Oy** — și subliniez: **un caz particular** al parabolelor din plan. Parabolele cu axă orizontală sau parabolele rotite (vom vedea la conice) nu se pot scrie ca grafic y = f(x), au nevoie de ecuații mai generale.

Trei coeficienți, trei roluri: **a** decide direcția ramurilor și deschiderea; **b** poziționează vârful pe orizontală; **c** este intersecția cu axa Oy, pentru că f(0) = c. Axa de simetrie este x = −b/(2a) — o dreaptă verticală."

## 05 · FORMA CANONICĂ (1 min)

🗣 „**Teoremă: orice funcție de gradul al II-lea se poate scrie sub forma canonică f(x) = a(x − m)² + n**, unde V(m, n) este vârful parabolei.

Demonstrația e completarea pătratului: scot a factor comun, adun și scad pătratul lui b/2a, obțin a(x + b/2a)² − Δ/(4a). De aici: **m = −b/(2a)** și **n = −Δ/(4a)**.

Forma canonică e tocmai translația din slide-ul precedent: același tipar y = ax², mutat cu m pe orizontală și cu n pe verticală."

## 06 · DISCRIMINANTUL (1 min)

🗣 „**Definiție: numărul Δ = b² − 4ac se numește discriminantul ecuației ax² + bx + c = 0.**

Discriminantul controlează poziția parabolei față de axa Ox: **Δ > 0** — două rădăcini reale distincte; **Δ = 0** — rădăcină dublă, parabola tangentă; **Δ < 0** — nicio rădăcină reală. În plus, Δ apare și în ordonata vârfului, n = −Δ/(4a), deci controlează cât de sus sau jos e vârful."

## 07 · RĂDĂCINILE (45 sec)

🗣 „**Teoremă — formula rădăcinilor: pentru Δ ≥ 0, x₁,₂ = (−b ± √Δ)/(2a).** Suma e −b/a, produsul e c/a, distanța dintre rădăcini |x₁ − x₂| = √Δ/|a|, iar factorizarea f(x) = a(x − x₁)(x − x₂)."

## 08 · VIÈTE (45 sec)

🗣 „**Teorema lui Viète: x₁ + x₂ = −b/a și x₁ · x₂ = c/a.** Demonstrația e direct din formula rădăcinilor: adunând, radicalii se anulează; înmulțind, obținem (b² − Δ)/(4a²) = 4ac/(4a²) = c/a. Utilă în ambele direcții — și pentru reconstrucția ecuației: x² − Sx + P = 0."

## 09 · VÂRFUL (45 sec)

🗣 „**Vârful parabolei este V(−b/(2a), −Δ/(4a))**, citit direct din forma canonică. Dacă a > 0 — minim, ramuri în sus; dacă a < 0 — maxim, ramuri în jos. Axa de simetrie e dreapta verticală x = −b/(2a)."

## 10 · SEMNUL (45 sec)

🗣 „Regula clasică: **f are semnul lui a în afara rădăcinilor și semn contrar între rădăcini**. Dacă Δ ≤ 0, nu mai există «între», funcția păstrează semnul lui a peste tot."

## 11 · CELE 6 CAZURI (30 sec)

🗣 „Toate combinațiile dintre semnul lui a și cel al lui Δ dau exact șase poziții posibile ale parabolei față de Ox. Orice exercițiu de încadrare se reduce la una dintre aceste șase imagini."

🖱 *(opțional)* Click pe un card → se deschide fereastra mare. Escape să închizi.

## 12 · CALCULATORUL (1 min — DEMO)

🗣 „Calculator interactiv: mut coeficienții și totul se recalculează live."

🖱 **Demo:** pornește de la a=1, b=0, c=−4 → „rădăcinile ±2". Mută **c** spre +2 → „Δ negativ, parabola s-a ridicat peste axă". Mută **a** la −1 → „maxim, nu minim".
...
## 18 · TOATE PARABOLELE SUNT ASEMENEA (1 min)
...
→ „Pentru că funcția de gradul II acoperă doar parabolele cu axă verticală — un caz particular. Definiția cu focar și directoare include toate parabolele din plan, inclusiv pe cele rotite (vezi conicele, slide 17). Așa graficul devine consecință, nu definiție."
...
- 02–04 (fundamentele geometrice): toate trei intacte — ele sunt cheia rigorii. **4 min**.
- 05–11 (forma canonică, discriminant, rădăcini, Viète, vârf, semn, 6 cazuri): doar definiția + o frază fiecare. **3 min**.
- 12 (Calculator): un singur gest. **30 sec**.
- 13–18 (cercetarea): toate intacte. **~6 min**.
- Demo-uri live obligatorii: **înfășurătoarea (13), cercul osculator cu h → 0 (15), conicele (17)**.
