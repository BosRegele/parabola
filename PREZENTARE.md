...
> **Durata totală: ~18 de minute** (versiunea completă) sau **~13 minute** (versiunea comprimată).
> Numerotarea de mai jos e cea din contorul de pe ecran (01/14 … 14/14).
...
## 06 · POZIȚIA FAȚĂ DE AXA Ox (1 min)

🗣 „Întrebarea naturală: **câte puncte comune are parabola cu axa Ox?** Răspunsul îl dă discriminantul. **Δ = b² − 4ac decide numărul de intersecții cu Ox**: dacă Δ > 0 — două puncte, dacă Δ = 0 — unul singur (parabola e tangentă la axă, chiar în vârf), dacă Δ < 0 — niciunul, curba nu atinge axa.

Combinând acest număr cu **semnul lui a** — care decide dacă ramurile merg în sus sau în jos — obținem **exact șase configurații posibile** ale parabolei față de axa Ox. Le aveți pe toate șase desenate; orice exercițiu de încadrare se reduce la una dintre ele."

🖱 *(opțional)* Click pe oricare desen → se deschide fereastra mare cu toate valorile. Escape să închizi.

## 07 · CALCULATORUL (1 min — DEMO)
...
## 12 · CONICA GENERALĂ ȘI MATRICEA EI (2 min)
...
## 13 · TOATE PARABOLELE SUNT ASEMENEA (1 min)
...
→ „Pentru că funcția de gradul II acoperă doar parabolele cu axă verticală — un caz particular. Definiția cu focar și directoare include toate parabolele din plan, inclusiv pe cele rotite (vezi conicele, slide 12). Așa graficul devine consecință, nu definiție."
...
- 05–06 (elementele parabolei, poziția față de Ox): o frază + arăți graficul. **1,5 min**.
- 07 (Calculator): un singur gest. **30 sec**.
- 08–13 (cele șase perspective avansate): intacte. **~5 min**.
- Demo-uri live obligatorii: **înfășurătoarea (08), cercul osculator cu h → 0 (10), conicele (12)**.
